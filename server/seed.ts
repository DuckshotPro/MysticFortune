...
export async function seedDatabase() {
  try {
    ...
    // Seed horoscopes
    const horoscopeData = [
      { sign: ZodiacSigns.ARIES, content: "Today's cosmic energy ignites your pioneering spirit, dear Aries. Mars, your ruling planet, bestows courage for new beginnings. Trust your instincts and take that leap of faith you've been contemplating." },
      { sign: ZodiacSigns.TAURUS, content: "Venus graces your sign with abundance and beauty, steadfast Taurus. Material and emotional security flourish under today's celestial influence. Plant seeds of intention in fertile ground." },
      { sign: ZodiacSigns.GEMINI, content: "Mercury dances through your communication sector, clever Gemini. Words carry extra power today - use them wisely to inspire and connect. Your curiosity opens unexpected doors." },
      { sign: ZodiacSigns.CANCER, content: "The Moon illuminates your emotional depths, sensitive Cancer. Family and home matters take precedence under today's nurturing energy. Trust your intuitive guidance in all decisions." },
      { sign: ZodiacSigns.LEO, content: "The Sun shines brilliantly on your creative expression, radiant Leo. Your natural magnetism attracts opportunities and admirers alike. Share your gifts generously with the world." },
      { sign: ZodiacSigns.VIRGO, content: "Earth energy supports your practical endeavors, meticulous Virgo. Details others overlook become your stepping stones to success. Your service to others creates positive karma." },
      { sign: ZodiacSigns.LIBRA, content: "Balance and harmony flow through your relationships, graceful Libra. Partnerships reach new levels of understanding and cooperation. Beauty surrounds you in unexpected forms." },
      { sign: ZodiacSigns.SCORPIO, content: "Transformation beckons from the depths, mysterious Scorpio. What appears to end actually begins anew in a more powerful form. Embrace your regenerative abilities." },
      { sign: ZodiacSigns.SAGITTARIUS, content: "Jupiter expands your horizons beyond familiar boundaries, adventurous Sagittarius. Higher learning and distant travels call to your restless spirit. Seek truth through experience." },
      { sign: ZodiacSigns.CAPRICORN, content: "Saturn rewards your persistent efforts with tangible results, ambitious Capricorn. Long-term goals manifest through disciplined action. Your reputation grows stronger." },
      { sign: ZodiacSigns.AQUARIUS, content: "Uranus electrifies your innovative thinking, visionary Aquarius. Revolutionary ideas flow through your consciousness like lightning. Your uniqueness becomes your superpower." },
      { sign: ZodiacSigns.PISCES, content: "Neptune enhances your psychic sensitivity, intuitive Pisces. Dreams and meditation reveal hidden truths about your spiritual path. Compassion heals both yourself and others." }
    ];
